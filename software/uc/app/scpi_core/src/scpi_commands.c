...
#ifndef SCPI_COMMANDS
#define SCPI_COMMANDS(X)
#endif /* ifndef SCPI_COMMANDS */
...
static const scpi_command_t scpi_commands[] = {
  ...
  /* SCPI device specific commands */
  SCPI_COMMANDS(SCPI_ENTRY)
...
Result SCPI_CoreInit(transport_t *transport) {
  ...
  // scpi_context.interface->error = NULL; // TODO: Add error callback with
  // logging
  return R_Success;
}
